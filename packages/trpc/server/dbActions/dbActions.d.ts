export declare const dbActionsRoutes: import("@trpc/server/unstable-core-do-not-import").BuiltRouter<{
    ctx: object;
    meta: object;
        ...
        output: import("../../helpers.js").TBackendRes<null> | import("../../helpers.js").TBackendRes<{
            editors: ({
                editor: {
                    ...
                    trialEndAt: import("@prisma/client/runtime/library").JsonValue | null;
                };
            } & {
                videoId: string;
                editorEmail: string;
...
//# sourceMappingURL=dbActions.d.ts.map